...
describe("rajahApp:", function () {
    ...
    describe("Method create:", function () {
        ...
        xit("should set config-info into object", function () {
            var rajah = rajahAppcreate(DUMMY_CONFIG);
            expect(rajah.config).toEqual(ADDED_CONFIG);
        });
    });

    xdescribe("Method loadPackageJson:", function () {
     ...
     */
    xdescribe("Method setup:", function () {
     ...
     *    7) user source files
     */
    xdescribe("Methods to add source files:", function () {
    ...
    /*
     *  Method compile:
     *  - get filename from rajahAppobject.
     *  - read and wrap source files, and merge them.
     *  - store that into rajahAppcontent.
     */
    xdescribe("Method compile:", function () {
        ...
        describe("Static Private Method _compileFilesList:", function () {
            ...
            it("should wrap files and return merged one.", function () {
                ...
                var content = rajahApp_compileFilesList(filesList, mockfs);
            ...
            it("should return null when filetype is invalid.", function () {
                ...
                expect(function () {
                    rajahApp_compileFilesList(filesList, mockfs);
                }).toThrow();
            });
        });
